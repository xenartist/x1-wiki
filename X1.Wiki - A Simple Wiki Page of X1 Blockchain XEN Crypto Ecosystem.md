...
| [XOLANA SVM VALIDATOR TUTORIAL](https://www.youtube.com/watch?v=o61ROj-H0zY) | XOLANA Validator Guide by XEN TZU (YouTube Video) |
| [XOLANA Validator Guide](xolana/index.html)                  | XOLANA Validator Guide by xen_artist              |
| [XOLANA Validator Guide](https://node.z4ch.xyz/nodes-+-providers/xolana-validator-guide) | XOLANA Validator Guide by z4ch nodes              |
...
| [xenblocks lightnode](https://github.com/jacklevin74/voter)  | Voter fetches records from XENBLOCKs ledger and runs verification in CPU |
| [xenblocks-webvoter](https://bulkminter.com/xenblocks-webvoter/) | Xenblocks Web Voter - Voter fetches records from XENBLOCKs ledger and runs verification in CPU |
