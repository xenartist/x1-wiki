...
| [XDEX](https://xdex.xyz/)             | Decentralized Exchange built for the X1 Blockchain. <br />Swap, trade and provide liquidity on the XDEX. |
...
| [x1node](https://www.x1node.com/)                            | X1 Validator Dashboard - Stake your XNT tokens to secure the X1 blockchain and earn rewards |
| [xenobi-x.one](https://xenobi-x.one/)                        | X1 Validator Dashboard by xenobi                             |
